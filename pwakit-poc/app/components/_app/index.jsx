...
const App = (props) => {
    ...
    const {data: privacyPolicy} = useQuery({
        ...
        queryFn: () => { return fetch(`${getAppOrigin()}/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/content/privacy-policy?client_id=8b494dab-f629-47f6-a678-581c5b88e625`).then(res=>res.json()).then((json) => {
            console.log(json)
            return json
        })
        },
